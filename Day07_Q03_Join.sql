...
/*=============================== INNER JOIN  ==================================
    ...
    2) From'dan sonra table_name yazarken 
       ...
       1. table_name ve kisaltmasi + INNER JOIN + 2. table_name ve kisaltmasi yazabiliriz.
...
FROM bolumler INNER JOIN personeller
ON bolumler.bolum_id = personeller.bolum_id
WHERE bolumler.bolum_isim IN ( 'SATIS', 'MUHASEBE')
...
/*
  ...
  */
  ...
  ORDER BY personeller.personel_isim, bolumler.bolum_isim;
...
*/
  ...
  FROM bolumler RIGHT JOIN personeller
  ON bolumler.bolum_id = personeller.bolum_id
  ORDER BY  bolumler.bolum_isim DESC ,  personeller.maas ASC;
  ...
  siralayarak listeleyiniz.  HAVING ile cozumunu de yapiniz.
  */
