...
UPDATE urun
SET urun_ismi = (SELECT isim FROM tedarik 
...
UPDATE urun
SET musteri_isim = (SELECT irtibat FROM tedarik
					WHERE isim = 'IBM')
WHERE urun_ismi = 'TV';
...
UPDATE urun
SET urun_ismi=(SELECT isim FROM tedarik WHERE id='102')
WHERE urun_id='1001';
...
-- urun tablosu child tablo oldugundan once FOREIGN KEY olan 
-- tedarikci_id parent tabloya eklenmesi gerekir
...
-- urun tablosu child tablo oldugundan once FOREIGN KEY olan 
-- tedarikci_id 110'un parent tabloya eklenmesi gerekir

INSERT INTO tedarik VALUES (110, 'XIAOM', 'Mehmet KERES');
...
UPDATE cocuklar
SET grade = (SELECT yazili_notu FROM puanlar
...
UPDATE cocuklar
SET veli_isim = (SELECT ders_adi FROM puanlar
