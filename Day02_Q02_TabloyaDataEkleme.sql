...
VALUES (1,'Savaş ve Barış',	1869, 'Tarihi');
...
INSERT INTO kitaplar ()
VALUES  (1,	'Savaş ve Barış', 1869,'Tarihi' ),
		(2,	'Suç ve Ceza', 1866, 'Psikolojik'),
		(3,	'Anna Karenina', 1877, 'Aşk'),
		(4,	'1984',	1949, 'Politik'),
		(5,	'Büyük Umutlar', 1861, 'Dram'),
		(6,	'Don Kişot', 1605, 'Macera'),
		(7,	'Gurur ve Önyargı',	 1813,	'Dram'),
		(8,	'Monte Kristo Kontu',	1844,	'Macera'),
		(9,	'Faust', 1808,	'Felsefi'),
		(10,'Ulysses',	1922, 'Modernist');
...
VALUES(1, 'Ahmet', 'CELIK', '1988-10-06', 'Muhasebeci', 45000),
	  (2, 'Ayse', 'DEMIR', '1988-12-06', 'Mudur', 55000);
      
INSERT INTO personel () 
VALUES ('1', 'Mehmet' , 'YILMAZ' , '1993-03-01' , 'QA' , '50000');      
...
/*
    ========================  SORU  ========================
    Icerisinde ulke_adi, ulke_adi_uzun_yazilis, ISO_Kodu, ulke_kodu, baskent_turkce ve baskent_ingilizce columnlari olan bir ulkeler tablosu create ediniz.
    =========================================================
 */
...
/*  
    ========================  EXTRA ========================
    Icerisinde ulke_adi, baskent_turkce ve baskent_nufusu columnlari olan bir baskentler tablosu create ediniz. 
    =========================================================
 */
