...
-- isminde a harfi olan ogrencileirn yazili notunu 5 artirin
UPDATE kursiyer
...
WHERE veli_isim LIKE '____%';


-- veli ismin Hasan olan ogrenciyi silin
...
/*
TRUNCATE komutu tablodaki verileri geri getirilemeyecek sekilde siler
*/

-- kursiyer tablosundaki verileri TRUNCATE ile silelim
TRUNCATE kursiyer;
...
-- talebeler tablosu parent tavlo oldugu icin talebeler tablosundan silmeden once dereceler tablsoundan silmelisiniz 
