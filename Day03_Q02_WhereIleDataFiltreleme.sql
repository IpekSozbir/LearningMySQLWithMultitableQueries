...
-- kisiler tablosundan id sutununu silin
...
/*
 MySQL ozellikle belirtmedigimiz surece case sensitive degildir
 ...
 */
 ...
 SELECT * FROM kisiler
 WHERE sehir = 'İstanbul' OR sehir = 'Ankara' OR sehir = 'Izmir';
...
/*  
========================  SORU ========================
 Kisiler tablosundan  İstanbul, Izmir ve Ankarada yaşamayan kişileri listeleyiniz.
=========================================================
 */
...
SELECT * FROM kisiler 
WHERE NOT sehir != 'Istanbul' AND sehir != 'Izmir' AND sehir != 'Ankara'; 

/*
SELECT * FROM kisiler 
WHERE NOT sehir != 'Istanbul' OR sehir != 'Izmir' OR sehir != 'Ankara'; 

Bu kod yanlis olur 
Cunku OR operatoru iyimserdir
ornegin sehri Ankara olan bir kisi icin 2. ve 3. karsilastirmalar ture verir
...
SELECT * FROM kisiler 
WHERE NOT soyisim IN ( 'Kara',  'Yılmaz');
